...
const PayNowPage = () => {
  ...
  if (!allowed) {
    return (
      <Layout>
        <div className=" bg-black flex items-center justify-center min-h-screen text-center px-4">
          <div>
  ...
  return (
    <Layout>
      <div className= "bg-black mt-12 min-h-screen">
        <div className="max-w-6xl bg-black mx-auto px-4 py-8 pb-14">
