        ...
        <div className="space-y-2 py-3 border-t border-gray-200">
          <div className='flex items-center justify-between gap-2'>
            ...
            <div className="text-right">
              ...
              <p className="text-xs text-gray-500">{accommodation?.checkin_time?.substring(0, 5)}</p>
            </div>
          </div>
          ...
          <div className='flex items-center justify-between gap-2'>
            ...
            <div className="text-right">
              ...
              <p className="text-xs text-gray-500">{accommodation?.checkout_time?.substring(0, 5)}</p>
            </div>
          </div>
        </div>

        {/* Action Button */}
        <button className="w-full bg-[#CC9A55] hover:bg-[#b8885c] text-white font-medium py-2 px-3 rounded-lg text-sm transition-colors">
          View Details
        </button>
