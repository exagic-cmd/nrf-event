...
export function FeaturedVideoSection() {
  ...
  return (
    <section className="w-full py-12 md:py-24 lg:py-32 bg-muted relative z-10 overflow-hidden">
      {/* Background Icons */}
      ...
      <div className="container px-4 md:px-6 mx-auto max-w-7xl">
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 lg:gap-12">
          ...
          <div className="md:w-1/2 bg-surface p-8 rounded-xl shadow-md border border-border flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <div className="md:w-1/2 w-full flex justify-center items-center">
            <div className="w-full max-w-sm h-[500px] rounded-xl overflow-hidden shadow-lg border border-border">
              <iframe
