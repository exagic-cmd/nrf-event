 ...
 export function FestivalSection() {
  ...
  return (
    <section className="w-full py-12 md:py-24 lg:py-32 bg-white relative overflow-hidden">
      ...
      <img
        src= {`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}v1752749244/External%20Links/premium_photo-1698500034175-3520e1021c2f.avif`}
      ...
      />
      <img
        src={ `${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}v1752749244/External%20Links/photo-1541379889336-70f26e4c4617.avif` }
      ...
      />
      <img
        src={ `${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}v1752749243/External%20Links/photo-1527843320645-baeb96e80b5a.avif` }
      ...
      />
      <img
        src={ `${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}v1752749244/External%20Links/photo-1697124949788-857cb46e94dc.avif` }
      ...
      />
      <img
        src={ `${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}v1752749457/External%20Links/premium_photo-1666299721610-5853da3427ac.avif` }
