...
export default function HeroSection() {
  ...
  const smallScreenImageUrl =
    `${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}External+Links/lhsjacediff4b9pgp1al.svg`;
      ...
      <div className="  py-4 md:py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center ">
          ...
          <div className="flex flex-col justify-center space-y-4 text-center md:text-left px-2 md:px-8 lg:px-12">
            <div className="">
              <h1 className="text-xl lg:text-3xl font-semibold text-foreground ">
                PLAN YOUR TRIP TO NRF 2026 APAC
                <span className="text-primary block py-1.5 md:py-3 mt-2 text-3xl lg:text-5xl ">
