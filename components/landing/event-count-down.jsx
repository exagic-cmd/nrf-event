...
<div className="w-full p-6 sm:p-8 bg-white rounded-2xl shadow-xl border border-gray-200">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-gray-800">
    ...
    {/* End Date */}
    <div className="flex items-start gap-4">
      <Flag className="w-6 h-6 text-gray-700 mt-1" />
      <div>
    ...
    {eventDetails.time_zone?.name && (
      <div className="flex items-start gap-4">
        <Globe className="w-6 h-6 text-gray-700 mt-1" />
        <div>
    ...
    {/* {eventDetails.company_name && (
      <div className="flex items-start gap-4">
        <Building2 className="w-6 h-6 text-gray-700 mt-1" />
        <div>
    ...
    {/* {eventDetails.web_link && (
      <div className="flex items-start gap-4">
        <Globe2 className="w-6 h-6 text-gray-700 mt-1" />
        <div>
    ...
    {/* {(eventDetails.fb_link || eventDetails.twitter_link || eventDetails.linkedIn_link) && (
      <div className="flex items-start gap-4">
        <Share2 className="w-6 h-6 text-gray-700 mt-1" />
        <div>
  ...
  {eventDetails.short_desc && (
    <p className="mt-10 text-gray-700 border-t border-gray-200 pt-6 leading-relaxed">
