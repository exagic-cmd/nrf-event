    ...
    <div className="min-h-screen bg-muted">
      ...
      <section className="relative bg-gradient-to-r from-[#FE6F4F] to-[#FE6F4F]/80 text-white">
        <div className="absolute inset-0">
          <Image
            src={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}External+Links/nkfcjd8vlm4vcphzt5vv.svg`}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {courses.map((course) => (
              <Card
                key={course.id}
                className="group cursor-pointer border-0 shadow-md"
              ...
              >
                ...
                <CardHeader className="">
                  <CardTitle className="text-lg line-clamp-1 font-semibold text-foreground group-hover:text-[#FE6F4F] transition-colors">
                    {course.title}
                  </CardTitle>
                ...
                <CardContent className="">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      className="text-[#FE6F4F] hover:text-[#FE6F4F] hover:bg-[#FE6F4F]/10 p-3"
                    >
                      View Details
      ...
      <section className="py-16 bg-surface">
        <div className="max-w-full md:mx-8 lg:mx-14 mx-4 px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
       ...
       <Accordion type="double" collapsible className="space-y-4">
