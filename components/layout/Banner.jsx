...
<div className='absolute bottom-2 left-2 md:bottom-4 md:left-12 lg:bottom-6 lg:left-16 xl:bottom-6 xl:left-20 z-10'>
    <MelvinChatStrap />
                ...
                <div className="md:w-1/2 md:mt-2 mt-4 flex justify-center relative">
                    <img
                        src={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}External+Links/fajvtmcexqcequ2jw0ib.svg`}
                    ...
                    />
                    <img
                        src={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}External+Links/s0xu2tzpohho94zmvmru.svg`}
                      alt="Illustration of AI travel planner for Singapore"
                        className="hidden sm:block"
                    />
                    <div className="hidden md:hidden lg:block absolute top-4 left-0">
                        <img src={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}External+Links/gvdtuzdjigjgdjqnzchp.svg`} alt="hotline" />
                    </div>
                    <div className="hidden md:hidden lg:block absolute bottom-4 right-0 md:right-20">
                        <img src={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}External+Links/xitzdvx70fpat1j2qv6z.svg`} alt="hotline2" />
                    </div>
                </div>
            </div>

            <div className="absolute top-[5] left-[50%] transform -translate-x-1/2 -translate-y-1/2 hidden lg:block">
               <img src={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}External+Links/pcrzo75z5womwynfwpih.svg`} alt="Sparkle Large" className="h-24 w-24 " />
            </div>
