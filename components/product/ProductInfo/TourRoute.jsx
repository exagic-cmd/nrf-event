            ...
            <div key={stop.id} className="relative pl-16 py-4 mb-10">
              ...
              {stop.travel_mode === "DRIVING" ? (
                <div className="mt-12 absolute left-0 bottom-1 z-10 w-12 h-12 rounded-full bg-white text-black flex items-center justify-center border border-gray-300 shadow-md">
                  <img
                    className="h-6 w-6"
                    src="https://res.cloudinary.com/www-travelpakistani-com/image/upload/v1749022226/External%20Links/lf2qbooh2bgk15b01xdq.svg"
                    alt=""
                  />
                </div>
                ...
                <div className="mt-12 absolute left-0 bottom-1 z-10 w-12 h-12 rounded-full bg-white text-black flex items-center justify-center border border-gray-300 shadow-md">
                  <img
                    className="h-6 w-6"
                    src="https://res.cloudinary.com/www-travelpakistani-com/image/upload/v1749022225/External%20Links/wxi5gj9uzfrsydu3kdfj.svg"
                    alt=""
                  />
                </div>
              ) : null}
