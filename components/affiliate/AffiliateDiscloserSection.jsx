    ...
    <div className="my-16 px-4 md:px-12">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center bg-white">
        ...
        <div className="flex justify-center">
          <img
            src= {`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}v1753355608/External%20Links/front-view-young-beautiful-lady-grey-shirt-working-with-documents-laptop-sitting-inside-her-office-daytime-building-job-activity-min.jpg`}
