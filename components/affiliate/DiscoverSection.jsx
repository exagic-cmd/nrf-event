      ...
      <div className="container px-4 mx-auto">
        <div className="flex flex-col md:flex-row items-center relative">
          ...
          <div className="md:w-2/3 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="p-1 flex items-start gap-4">
                <img src={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}v1744797457/External%20Links/ghucj0rj36ocynxgn371.svg`} alt="Tour Types" />
                <div>
              ...
              {/* Card 2 */}
              <div className="p-1 flex items-start gap-4">
                <img src={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}v1744797456/External%20Links/jhrknqowjuddg7cflspy.svg`} alt="Accommodation" />
                <div>
              ...
              {/* Card 3 */}
              <div className="p-1 flex items-start gap-4">
                <img src={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}v1744797457/External%20Links/ddu7rwsxejrxy3xl5pb6.svg`} alt="Affiliate Program" />
                <div>
              ...
              {/* Card 4 */}
              <div className="p-1 flex items-start gap-4">
                <img src={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}v1744797456/External%20Links/gf99gdggyxyrsgyx3h3b.svg`} alt="Transfers" />
                <div>
          ...
          <div className="md:absolute md:bottom-0 md:right-12 mt-10 md:mt-0 w-[280px]">
            <img
              src={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}v1744797467/External%20Links/imcnm76fxa6agxkjsscr.svg`}
              alt="img"
