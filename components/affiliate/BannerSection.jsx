...
export default function BannerSection() {
  ...
  return (
    <div 
      ...
      style={{
        backgroundImage: `url(${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}External+Links/front-view-young-beautiful-lady-grey-shirt-working-with-documents-laptop-sitting-inside-her-office-daytime-building-job-activity-min.jpg)`,
