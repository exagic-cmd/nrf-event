  ...
  return (
    <div className="relative bg-pink-50 rounded-lg px-2 md:px-6 py-4 md:py-10  overflow-hidden">
      ...
      <div className="absolute top-2 left-1 md:left-6 h-8 w-8 md:h-18 md:h-18">
          ...
          <img src={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}upload/v1744797488/External+Links/yrgzbjyvjvyziduap2zr.svg`} alt="" />
      ...
      <img src={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}upload/v1744797456/External+Links/rtjzw49gojwwafkigfea.svg`} alt="" />
      </div>
