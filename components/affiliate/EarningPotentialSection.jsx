    ...
    <div>
      <div className="bg-white mb-6 px-6 md:px-12 relative">
        <div className="z-10">
          ...
          <img
            src="https://res.cloudinary.com/www-travelpakistani-com/image/upload/v1744197394/External%20Links/vvyjdk5xv8c9lyzpx6cd.svg"
            className="absolute left-0 bottom-10 w-24 md:w-32 z-0"
            alt=""
          />
          <img
            src="https://res.cloudinary.com/www-travelpakistani-com/image/upload/v1744197394/External%20Links/znwzu7tqfxetuy4krb5c.svg"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 items-center mt-10">
            ...
            <div className="flex flex-col md:items-end gap-8 mr-8 md:mx-14">
              ...
              <div className="flex items-end gap-4">
                <div className="shadow-md rounded-xl w-24 h-24 flex-shrink-0 flex items-center justify-center p-3">
                  <img src="https://res.cloudinary.com/www-travelpakistani-com/image/upload/v1744797471/External%20Links/joyd8h6oahpxvbsfvfdq.svg" alt="Commission Rates" className="w-full h-auto" />
                </div>
              ...
              <div className="flex items-end gap-4">
                <div className="shadow-md rounded-xl w-24 h-24 flex-shrink-0 flex items-center justify-center p-3">
                  <img src="https://res.cloudinary.com/www-travelpakistani-com/image/upload/v1744797470/External%20Links/wouh7tjlg6gv8cpsjjpx.svg" alt="Onboarding" className="w-full h-auto" />
                </div>
                <div className="py-1 md:py-5 md:mt-0 mt-4">
            ...
            <div className="flex justify-center items-center">
              <img
                src="https://res.cloudinary.com/www-travelpakistani-com/image/upload/v1744797472/External%20Links/lvlszaahzrlttwqkjava.svg"
            ...
            <div className="flex flex-col gap-8 mr-2 md:mx-14">
              ...
              <div className="flex items-end gap-4 z-10">
                <div className="shadow-md rounded-xl w-24 h-24 flex-shrink-0 flex items-center justify-center p-3">
                  <img src="https://res.cloudinary.com/www-travelpakistani-com/image/upload/v1744797471/External%20Links/t38adqlkozkk4iwwpelg.svg" alt="Affiliates" className="w-full h-auto" />
                </div>
                <div className="py-1 md:py-5 md:mt-0 mt-4">
              ...
              <div className="flex items-end gap-4 z-10">
                <div className="shadow-md rounded-xl w-24 h-24 flex-shrink-0 flex items-center justify-center p-3">
                  <img src="https://res.cloudinary.com/www-travelpakistani-com/image/upload/v1744797467/External%20Links/jr6wrt6z8axsyzklwphx.svg" alt="Dashboard" className="w-full h-auto" />
                </div>
                <div className="py-1 md:py-5 md:mt-0 mt-4">
