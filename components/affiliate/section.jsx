...
const AffiliateSections = () => {
  ...
  return (
    <div className="bg-white min-h-screen py-6 px-4 sm:py-12 sm:px-6 md:px-8">
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl overflow-hidden">
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2">
                ...
                <ul className="space-y-3 sm:space-y-4">
                  {["updates", "strategies", "cases", "earlyAccess","qa"].map((key, idx) => (
                    <li key={idx} className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-[#CC9A55] rounded-full mt-2 flex-shrink-0"></div>
              ...
              <div className="space-y-4 sm:grid sm:grid-cols-2 sm:gap-4 sm:space-y-0 mb-6 sm:mb-8">
                <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <span className="font-semibold text-gray-800 text-sm sm:text-base">29 August 2025 <span className='text-xs text-gray-600'>- 7pm(SGT)</span> </span> 
                ...
                <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="font-semibold text-gray-800 text-sm sm:text-base">1 hour</p>
                  </div>
                </div>
              </div>

              {/* Zoom Link - Mobile Friendly */}
              <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg mb-6 sm:mb-8">
            ...
            <div className="bg-gradient-to-br from-[#CC9A55] via-black-50 to-purple-100 p-4 sm:p-6 lg:p-8 flex items-center justify-center relative order-1 lg:order-2 min-h-[300px] sm:min-h-[400px]">
              <div className="relative z-10 w-full max-w-sm">
                <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg overflow-hidden mb-4 sm:mb-6">
                  <img 
                    ...
                    src="https://res.cloudinary.com/www-travelpakistani-com/image/upload/v1753355608/External%20Links/close-up-people-working-from-home-min.jpg" 
              ...
              <div className="absolute top-4 right-4 w-16 h-16 sm:w-24 sm:h-24 bg-[#CC9A55] rounded-full opacity-30"></div>
              <div className="absolute bottom-8 left-4 w-12 h-12 sm:w-20 sm:h-20 bg-[#CC9A55] rounded-full opacity-40"></div>
              <div className="absolute top-1/2 right-2 w-10 h-10 sm:w-16 sm:h-16 bg-[#CC9A55] rounded-full opacity-25"></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl overflow-hidden">
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2">
            ...
            <div className="bg-gradient-to-br from-[#CC9A55] to-black-100 p-4 sm:p-6 lg:p-8 flex items-center justify-center relative min-h-[300px] sm:min-h-[400px] order-1">
              <div className="relative z-10 w-full max-w-sm">
                <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg p-4 sm:p-6 mb-4 sm:mb-6">
                  <div className="bg-gradient-to-r from-[#CC9A55] to-teal-500 rounded-2xl overflow-hidden mb-4">
                    <img 
                      className='w-full h-32 sm:h-40 md:h-48 object-cover' 
                      src="https://res.cloudinary.com/www-travelpakistani-com/image/upload/v1754543928/External%20Links/WhatsApp_Image_2025-08-07_at_10.15.44_ab74f60f.jpg" 
                      alt="Certification program" 
                    />
                  </div>
                  <div className="grid grid-cols-2 gap-3 sm:gap-4 text-center">
                    <div className="bg-[#CC9A55] rounded-lg sm:rounded-xl p-2 sm:p-3">
              ...
              {/* Decorative circles - adjusted for mobile */}
              <div className="absolute top-4 left-4 w-16 h-16 sm:w-24 sm:h-24 bg-[#CC9A55] rounded-full opacity-30"></div>
              <div className="absolute bottom-8 right-4 w-12 h-12 sm:w-20 sm:h-20 bg-[#CC9A55] rounded-full opacity-35"></div>
              <div className="absolute top-1/2 left-2 w-10 h-10 sm:w-16 sm:h-16 bg-[#CC9A55] rounded-full opacity-25"></div>
            </div>
