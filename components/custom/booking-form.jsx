      ...
      <div className="w-full md:mx-8 mx-2 lg:mx-12 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="hidden lg:block">
          <div className="relative">
            <img
              src="https://res.cloudinary.com/www-travelpakistani-com/image/upload/v1757328212/External%20Links/modern-urban-cityscape-with-person-getting-into-bl_2.jpg"
