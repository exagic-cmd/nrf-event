import { Check, X, Utensils, Calendar, Shield, Bed } from "lucide-react";
...
const RoomTypes = ({
  ...
  // Sync internal selection with external selectedRoom
  useEffect(() => {
  ...
  // Group rooms by roomType for clean display
  ...
  const getCancellationDisplay = (policy) => {
    ...
    if (p.includes("refundable") || p.includes("free")) {
      return {
        ...
        desc: "Cancel for free",
      };
    }
    return {
      text: policy || "Check Policy",
