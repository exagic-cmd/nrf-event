  ...
  return (
    ...
    : t("tripType.oneWay")}
          <div onClick={SearchClicked} className="justify-items-end cursor-pointer">
            <p className="text-[#CC9A55] text-xs font-semibold bg-gray-100 rounded-md p-1 ">{t('change')}</p>
          </div>
        </div>
      )}
      ...
      <div className="flex items-start">
        ...
        <div className="flex flex-col items-center mr-2 mt-1">
          ...
          <div className="w-2 h-2 bg-[#CC9A55] rounded-full"></div>
        </div>
        ...
        <div>
          ...
          <p className="text-[13px] text-[#CC9A55] font-semibold">{dropoff?.name}</p>
        </div>
      </div>
