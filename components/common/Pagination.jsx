        ...
        <button
          ...
          className={`px-4 py-2 border rounded-md text-sm font-medium transition-colors ${
            currentPage === 1
              ...
              : "bg-white text-gray-700 hover:bg-[#CC9A55] hover:text-white border-gray-300"
          }`}
        >
          Previous
        </button>
        ...
        <button
          ...
          className={`px-4 py-2 border rounded-md text-sm font-medium transition-colors ${
            currentPage === totalPages
              ? "bg-gray-100 text-gray-400 cursor-not-allowed border-gray-200"
              : "bg-white text-gray-700 hover:bg-[#CC9A55] hover:text-white border-gray-300 hover:bg-[#CC9A55]"
          }`}
        >
          Next
        </button>
