    ...
    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center">
      ...
      <div className="relative bg-white rounded-t-xl sm:rounded-xl p-4 sm:p-6 max-w-md w-full mx-4 shadow-lg">
        <div className="flex justify-between items-start">
          <h3 className="text-lg font-semibold">Time's up for this hold</h3>
        ...
        <div className="mt-4 flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <div className="text-sm text-gray-500">The hold for this accommodation has expired. Would you like to extend it?</div>
          </div>
        </div>
